...
import { InputLabel } from '../../common/form/label-component'
import { errorNotice, successNotice } from '../../../utilities/notification'
import { CancelButton, SelectComponent, SubmitButton } from '../../common/form/input-component'
...
const OrderView = () => {
    ...
    const getOrderDetail = async () => {
        try {
            const response: any = await dashboardService.getRequest('/order/customer/' + params.id, { auth: true })
    ...
    return (<div className='m-4'>
        <div className='p-5  bg-slate-50'>
            ...
            <div className='flex justify-items-start gap-10'>
                ...
                <div className='flex gap-2'>
                    <p className="text-l font-semibold">Seller Name:</p>
                    <p className="text-l">{order.seller?.name}</p>
                </div>
            </div>
        </div>
